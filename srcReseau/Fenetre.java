...
//        pano4_11.add(piece);
    ...
    public void changerVersion2(){
        ...
        JPanel pano1 = new JPanel();
        pano1.setPreferredSize(new Dimension(100,50));
        pano1.setBackground(new Color(61, 205, 227));
        JLabel labelTitle = new JLabel("TETRIS");
        labelTitle.setFont(new Font("Serif", Font.BOLD, 24));
        pano1.add(labelTitle);
        panelGlobal.add(pano1,BorderLayout.NORTH);
        ...
        JPanel pano2 = new JPanel();
        pano2.setLayout(new BoxLayout(pano2, BoxLayout.Y_AXIS));
        pano2.setBackground(new Color(61, 205, 227));


        JPanel pano2_1 = new JPanel();
        pano2_1.setBackground(new Color(61, 205, 227));
        pano2_1.setBorder(new LineBorder(Color.BLACK));
        ...
        JPanel pano2_2 = new JPanel();
        pano2_2.setBackground(new Color(61, 205, 227));
        pano2_2.setBorder(new LineBorder(Color.RED));
        ...
        pano2_3.setBackground(new Color(61, 205, 227));
        pano2_3.setBorder(new LineBorder(Color.ORANGE));
        ...
        pano2_4.setBackground(new Color(61, 205, 227));
        pano2_4.setBorder(new LineBorder(Color.yellow));
    ...
    public ImageIcon[] listeImages(){
        String chemin="";
        chemin += "images";
        ImageIcon [] listeImages=new ImageIcon[6];
        try{
...
//    public BufferedImage getImageCachee(){
//        return pictureCachee;
//    }
